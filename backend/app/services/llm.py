...
#     """
#     Transcribe audio via the gateway, with the same retry/backoff/logging contract as call_llm.

#     `audio_bytes` is the raw audio content; `filename` should carry a real extension
#     (e.g. 'answer.webm', 'recording.ogg') so the API can detect the format correctly.
#     """
#     last_error = None
