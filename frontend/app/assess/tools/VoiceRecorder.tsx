...
// export default function VoiceRecorder({ question, onSubmit, isSubmitting = false, sessionId }: VoiceRecorderProps) {
...
//       try {
//         const res = await fetch(`/api/sessions/${sessionId}/questions/${question.id}/answer`);
//         const data = await res.json();
//         if (data.exists) {
//           setAlreadyAnswered(true);
//         }
//       } catch {
//         // fail open — see explanation below
//       } finally {
...
//       `/api/sessions/${sessionId}/questions/${question.id}/voice-answer`,
//       { method: "POST", body: formData }
//     );
//     const data = await res.json();
//     onSubmit({ voice_result: data });
//   } else if (typedFallback.trim()) {
//     onSubmit({ no_audio: true, typed_answer: typedFallback });
//   } else {
